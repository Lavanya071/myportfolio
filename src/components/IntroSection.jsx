      ...
      <div className="intro-container">
        <div className="intro-text">
          ...
          <div className="intro-links">
            ...
            <a href="http://www.linkedin.com/in/lavanya-maila-6177242a7" target="_blank" rel="noopener noreferrer" className="intro-btn">🔗 LinkedIn</a>
            <a href="https://github.com/Lavanya071" target="_blank" rel="noopener noreferrer" className="intro-btn">💻 GitHub</a>
          </div>
        </div>
